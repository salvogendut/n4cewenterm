; N4C-NETINIT - Key=Value format parser
; Based on robust file reading pattern
; Config format: IP=192.168.68.254
...
; Character constants
CHAR_EQUALS     equ 61          ; '=' character

; Character constants (removed unused memory constants)

;=======================================================
; N4C_INIT - Read and parse config file
;=======================================================
N4C_INIT:
    push hl
    push de
...
.clear:
    ...
    ; Read the file using CAS_IN_CHAR (not DIRECT)
    ld hl, file_buffer
    ld c, 60
...
msg_err_open:   db "ERROR: Cannot open N4C.CFG",13,10,0
msg_err_w5100:  db "ERROR: W5100S not responding",13,10,0

filename_buffer: ds 12
